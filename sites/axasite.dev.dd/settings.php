...
if (isset($_SERVER['DEVDESKTOP_DRUPAL_SETTINGS_DIR']) && file_exists($_SERVER['DEVDESKTOP_DRUPAL_SETTINGS_DIR'] . '/cld_devcloud_axasite_dev_axa_site.inc')) {
  require $_SERVER['DEVDESKTOP_DRUPAL_SETTINGS_DIR'] . '/cld_devcloud_axasite_dev_axa_site.inc';
}
// </DDSETTINGS>

if (file_exists('/var/www/site-php')) {
  require '/var/www/site-php/axasite/axasite-settings.inc';
}