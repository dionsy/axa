             ...
             <div class="row">
                ...
                <div class="user col-md-3 col-lg-3 col-sm-6 col-xs-12"> 
                    ...
                    if(!user_is_logged_in()){
                      ...
                      print '<div class="mon_espace_client" ><a href="'.$base_path.'node/2" target="_blank" class="es_cli"><i class="fa fa-user" aria-hidden="true" style="margin-right:7px;"></i>Espace client</a></div>';
                    }
                 ?>
                 <?php
                  ?>        
